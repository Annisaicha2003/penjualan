            ...
            <div class="card-body">
                <form action="<?= site_url('barang/save') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="FKkategori_id" name="FKkategori_id" placeholder="Kategori" required>
                    </div>

                    <div class="mb-3">
                        <label for="FKsatuan_id" class="form-label">Satuan</label>
                        <input type="text" class="form-control" id="FKsatuan_id" name="FKsatuan_id" placeholder="Satuan" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="FKsuplier_id" name="FKsuplier_id" placeholder="Supplier" required>
                    </div>

    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <a href="<?= site_url('supplier/add')?>"><i class="fas fa-plus"></i>  Add New</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <div>
                                        ...
                                        <a href=".base_url('supplier/delete/'.$supplier->id)." class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data supplier ini?\");'><i class='fas fa-trash'></i> Hapus</a>
                                    </div>
                                </td>
                            </tr>";
                            $no++;
